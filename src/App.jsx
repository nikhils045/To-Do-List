...
function App() {
  ...
  const saveToLS = (params) => {
    ...
    console.log("Saving todos to local storage:", todos); // Debugging
  };
  ...
  return (
    <>
      <Navbar />
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-[#fbffc3] min-h-[80vh] md:w-[35%]">
        <h1 className="font-bold text-center text-2xl md:text-3xl">Notes</h1>
